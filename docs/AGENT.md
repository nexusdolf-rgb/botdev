...
- Commits en français, préfixés par un numéro de version (dernier : **v329**) avec description détaillée
...
- Dernière version : **v329** — rôles par réaction : titre du message
