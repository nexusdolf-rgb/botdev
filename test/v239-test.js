...
async function main() {
  ...
  check('index.html : ?v=246 référencé 7 fois', (index.match(/\?v=246/g) || []).length === 7,
    `trouvé ${(index.match(/\?v=246/g) || []).length}`);
  check("sw.js : cache 'botdev-v246'", sw.includes("const CACHE = 'botdev-v246';"));
