...
check('index.html : 7 références ?v=254', (read('public/index.html').match(/\?v=254/g) || []).length === 7);
check('index.html : plus aucune référence ?v=229', !read('public/index.html').includes('?v=229'));
check('sw.js : cache botdev-v241', read('public/sw.js').includes("const CACHE = 'botdev-v254';"));
