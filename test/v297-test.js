...
(async () => {
  ...
  check('index.html : ?v=323 référencé 7 fois', (index.match(/\?v=323/g) || []).length === 7, String((index.match(/\?v=323/g) || []).length));
  check('sw.js : cache « botdev-v323 »', racine('public/sw.js').includes("const CACHE = 'botdev-v323';"));
