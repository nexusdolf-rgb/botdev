...
assert(versions.every((v) => v === '?v=145'));
assert(sw.includes("const CACHE = 'botdev-v145';"));
console.log('3️⃣  Cache frontend : index.html et service worker synchronisés en v145 ✅');
