...
assert(versions.every((v) => v === '?v=143'));
assert(sw.includes("const CACHE = 'botdev-v143';"));
console.log('3️⃣  Cache frontend : index.html et service worker synchronisés en v143 ✅');
