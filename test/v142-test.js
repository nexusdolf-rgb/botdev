...
assert(versions.every((v) => v === '?v=144'));
assert(sw.includes("const CACHE = 'botdev-v144';"));
console.log('3️⃣  Cache frontend : index.html et service worker synchronisés en v144 ✅');
