...
(async () => {
  ...
  // 3 paragraphes + 1 bloc de compteurs = 4 blocs → 3 séparateurs.
  ...
  check('giveaway terminé : 3 séparateurs natifs entre sections (pied retiré en v306)', gwDiv(embEnd) === 3);
  ...
  // 2 paragraphes + 1 bloc de compteurs = 3 blocs → 2 séparateurs
  // (v306 : plus de séparateur du pied, signature retirée).
  ...
  // 1 paragraphe + 1 bloc de compteurs = 2 blocs → 1 séparateur (pied retiré en v306).
