...
(async () => {
  ...
  check('index : bump v216', fs.readFileSync('public/index.html', 'utf8').includes('?v=305'));
  check('sw : bump botdev-v241', fs.readFileSync('public/sw.js', 'utf8').includes('botdev-v305'));
