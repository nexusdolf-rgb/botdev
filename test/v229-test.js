...
check('index.html : 7 références ?v=275', (src('public/index.html').match(/\?v=275/g) || []).length === 7);
check('index.html : plus aucune référence ?v=236', !src('public/index.html').includes('?v=236'));
check('sw.js : cache botdev-v241', src('public/sw.js').includes("const CACHE = 'botdev-v275';"));
