...
check('index.html : ?v=271 référencé 7 fois', (racine('public/index.html').match(/\?v=271/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=271/g) || []).length));
check('sw.js : cache « botdev-v271 »', racine('public/sw.js').includes("const CACHE = 'botdev-v271';"));
