...
check('index.html : ?v=261 référencé 7 fois', (racine('public/index.html').match(/\?v=261/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=261/g) || []).length));
check('sw.js : cache « botdev-v261 »', racine('public/sw.js').includes("const CACHE = 'botdev-v261';"));
