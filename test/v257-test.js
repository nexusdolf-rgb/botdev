...
check('index.html : ?v=291 référencé 7 fois', (racine('public/index.html').match(/\?v=291/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=291/g) || []).length));
check('sw.js : cache « botdev-v291 »', racine('public/sw.js').includes("const CACHE = 'botdev-v291';"));
