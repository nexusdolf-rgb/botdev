...
check('index.html : ?v=268 référencé 7 fois', (racine('public/index.html').match(/\?v=268/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=268/g) || []).length));
check('sw.js : cache « botdev-v268 »', racine('public/sw.js').includes("const CACHE = 'botdev-v268';"));
