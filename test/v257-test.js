...
check('index.html : ?v=290 référencé 7 fois', (racine('public/index.html').match(/\?v=290/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=290/g) || []).length));
check('sw.js : cache « botdev-v290 »', racine('public/sw.js').includes("const CACHE = 'botdev-v290';"));
