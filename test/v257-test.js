...
check('index.html : ?v=286 référencé 7 fois', (racine('public/index.html').match(/\?v=286/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=286/g) || []).length));
check('sw.js : cache « botdev-v286 »', racine('public/sw.js').includes("const CACHE = 'botdev-v286';"));
