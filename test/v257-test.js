...
check('index.html : ?v=275 référencé 7 fois', (racine('public/index.html').match(/\?v=275/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=275/g) || []).length));
check('sw.js : cache « botdev-v275 »', racine('public/sw.js').includes("const CACHE = 'botdev-v275';"));
