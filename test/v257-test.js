...
check('index.html : ?v=278 référencé 7 fois', (racine('public/index.html').match(/\?v=278/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=278/g) || []).length));
check('sw.js : cache « botdev-v278 »', racine('public/sw.js').includes("const CACHE = 'botdev-v278';"));
