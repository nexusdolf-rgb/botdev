...
check('index.html : ?v=270 référencé 7 fois', (racine('public/index.html').match(/\?v=270/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=270/g) || []).length));
check('sw.js : cache « botdev-v270 »', racine('public/sw.js').includes("const CACHE = 'botdev-v270';"));
