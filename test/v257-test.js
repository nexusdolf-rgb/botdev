...
check('index.html : ?v=288 référencé 7 fois', (racine('public/index.html').match(/\?v=288/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=288/g) || []).length));
check('sw.js : cache « botdev-v288 »', racine('public/sw.js').includes("const CACHE = 'botdev-v288';"));
