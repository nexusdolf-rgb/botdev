...
check('index.html : ?v=285 référencé 7 fois', (racine('public/index.html').match(/\?v=285/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=285/g) || []).length));
check('sw.js : cache « botdev-v285 »', racine('public/sw.js').includes("const CACHE = 'botdev-v285';"));
