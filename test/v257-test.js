...
check('index.html : ?v=264 référencé 7 fois', (racine('public/index.html').match(/\?v=264/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=264/g) || []).length));
check('sw.js : cache « botdev-v264 »', racine('public/sw.js').includes("const CACHE = 'botdev-v264';"));
