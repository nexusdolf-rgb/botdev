...
check('index.html : ?v=279 référencé 7 fois', (racine('public/index.html').match(/\?v=279/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=279/g) || []).length));
check('sw.js : cache « botdev-v279 »', racine('public/sw.js').includes("const CACHE = 'botdev-v279';"));
