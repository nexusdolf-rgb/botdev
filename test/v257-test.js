...
check('index.html : ?v=281 référencé 7 fois', (racine('public/index.html').match(/\?v=281/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=281/g) || []).length));
check('sw.js : cache « botdev-v281 »', racine('public/sw.js').includes("const CACHE = 'botdev-v281';"));
