...
check('index.html : ?v=277 référencé 7 fois', (racine('public/index.html').match(/\?v=277/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=277/g) || []).length));
check('sw.js : cache « botdev-v277 »', racine('public/sw.js').includes("const CACHE = 'botdev-v277';"));
