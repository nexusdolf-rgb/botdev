...
check('index.html : ?v=259 référencé 7 fois', (racine('public/index.html').match(/\?v=259/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=259/g) || []).length));
check('sw.js : cache « botdev-v259 »', racine('public/sw.js').includes("const CACHE = 'botdev-v259';"));
