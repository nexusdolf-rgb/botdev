...
check('index.html : ?v=282 référencé 7 fois', (racine('public/index.html').match(/\?v=282/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=282/g) || []).length));
check('sw.js : cache « botdev-v282 »', racine('public/sw.js').includes("const CACHE = 'botdev-v282';"));
