...
check('index.html : ?v=280 référencé 7 fois', (racine('public/index.html').match(/\?v=280/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=280/g) || []).length));
check('sw.js : cache « botdev-v280 »', racine('public/sw.js').includes("const CACHE = 'botdev-v280';"));
