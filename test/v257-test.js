...
check('index.html : ?v=269 référencé 7 fois', (racine('public/index.html').match(/\?v=269/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=269/g) || []).length));
check('sw.js : cache « botdev-v269 »', racine('public/sw.js').includes("const CACHE = 'botdev-v269';"));
