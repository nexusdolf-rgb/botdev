...
check('index.html : ?v=289 référencé 7 fois', (racine('public/index.html').match(/\?v=289/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=289/g) || []).length));
check('sw.js : cache « botdev-v289 »', racine('public/sw.js').includes("const CACHE = 'botdev-v289';"));
