...
check('index.html : ?v=287 référencé 7 fois', (racine('public/index.html').match(/\?v=287/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=287/g) || []).length));
check('sw.js : cache « botdev-v287 »', racine('public/sw.js').includes("const CACHE = 'botdev-v287';"));
