...
check('index.html : ?v=272 référencé 7 fois', (racine('public/index.html').match(/\?v=272/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=272/g) || []).length));
check('sw.js : cache « botdev-v272 »', racine('public/sw.js').includes("const CACHE = 'botdev-v272';"));
