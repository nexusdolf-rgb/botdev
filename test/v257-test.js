...
check('index.html : ?v=274 référencé 7 fois', (racine('public/index.html').match(/\?v=274/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=274/g) || []).length));
check('sw.js : cache « botdev-v274 »', racine('public/sw.js').includes("const CACHE = 'botdev-v274';"));
