...
check('index.html : ?v=283 référencé 7 fois', (racine('public/index.html').match(/\?v=283/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=283/g) || []).length));
check('sw.js : cache « botdev-v283 »', racine('public/sw.js').includes("const CACHE = 'botdev-v283';"));
