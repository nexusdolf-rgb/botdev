...
check('index.html : ?v=260 référencé 7 fois', (racine('public/index.html').match(/\?v=260/g) || []).length === 7,
  String((racine('public/index.html').match(/\?v=260/g) || []).length));
check('sw.js : cache « botdev-v260 »', racine('public/sw.js').includes("const CACHE = 'botdev-v260';"));
