...
assert(versions.every((version) => version === '?v=161'));
assert(sw.includes("const CACHE = 'botdev-v161';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v161 ✅');
