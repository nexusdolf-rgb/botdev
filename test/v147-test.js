...
assert(versions.every((version) => version === '?v=178'));
assert(sw.includes("const CACHE = 'botdev-v178';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v178 ✅');
