...
assert(versions.every((version) => version === '?v=158'));
assert(sw.includes("const CACHE = 'botdev-v158';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v158 ✅');
