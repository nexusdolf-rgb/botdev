...
assert(versions.every((version) => version === '?v=148'));
assert(sw.includes("const CACHE = 'botdev-v148';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v148 ✅');
