...
assert(versions.every((version) => version === '?v=162'));
assert(sw.includes("const CACHE = 'botdev-v162';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v162 ✅');
