...
assert(versions.every((version) => version === '?v=151'));
assert(sw.includes("const CACHE = 'botdev-v151';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v151 ✅');
