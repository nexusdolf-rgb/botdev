...
assert(versions.every((version) => version === '?v=177'));
assert(sw.includes("const CACHE = 'botdev-v177';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v177 ✅');
