...
assert(versions.every((version) => version === '?v=150'));
assert(sw.includes("const CACHE = 'botdev-v150';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v150 ✅');
