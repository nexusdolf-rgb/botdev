...
assert(versions.every((version) => version === '?v=175'));
assert(sw.includes("const CACHE = 'botdev-v175';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v175 ✅');
