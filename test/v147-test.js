...
assert(versions.every((version) => version === '?v=170'));
assert(sw.includes("const CACHE = 'botdev-v170';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v170 ✅');
