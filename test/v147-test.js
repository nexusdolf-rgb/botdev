...
assert(versions.every((version) => version === '?v=152'));
assert(sw.includes("const CACHE = 'botdev-v152';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v152 ✅');
