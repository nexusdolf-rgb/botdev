...
assert(versions.every((version) => version === '?v=174'));
assert(sw.includes("const CACHE = 'botdev-v174';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v174 ✅');
