...
assert(versions.every((version) => version === '?v=166'));
assert(sw.includes("const CACHE = 'botdev-v166';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v166 ✅');
