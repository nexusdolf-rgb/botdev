...
assert(versions.every((version) => version === '?v=165'));
assert(sw.includes("const CACHE = 'botdev-v165';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v165 ✅');
