...
assert(versions.every((version) => version === '?v=176'));
assert(sw.includes("const CACHE = 'botdev-v176';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v176 ✅');
