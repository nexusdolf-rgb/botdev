...
assert(versions.every((version) => version === '?v=163'));
assert(sw.includes("const CACHE = 'botdev-v163';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v163 ✅');
