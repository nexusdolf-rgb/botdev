...
assert(versions.every((version) => version === '?v=179'));
assert(sw.includes("const CACHE = 'botdev-v179';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v179 ✅');
