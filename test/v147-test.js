...
assert(versions.every((version) => version === '?v=149'));
assert(sw.includes("const CACHE = 'botdev-v149';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v149 ✅');
