...
assert(versions.every((version) => version === '?v=159'));
assert(sw.includes("const CACHE = 'botdev-v159';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v159 ✅');
