...
assert(versions.every((version) => version === '?v=173'));
assert(sw.includes("const CACHE = 'botdev-v173';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v173 ✅');
