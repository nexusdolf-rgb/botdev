...
assert(versions.every((version) => version === '?v=160'));
assert(sw.includes("const CACHE = 'botdev-v160';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v160 ✅');
