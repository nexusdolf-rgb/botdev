...
assert(versions.every((version) => version === '?v=164'));
assert(sw.includes("const CACHE = 'botdev-v164';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v164 ✅');
