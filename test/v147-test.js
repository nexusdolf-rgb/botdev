...
assert(versions.every((version) => version === '?v=154'));
assert(sw.includes("const CACHE = 'botdev-v154';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v154 ✅');
