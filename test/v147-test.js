...
assert(versions.every((version) => version === '?v=169'));
assert(sw.includes("const CACHE = 'botdev-v169';"));
console.log('3️⃣  Cache frontend : assets et service worker synchronisés en v169 ✅');
