...
(async () => {
  ...
  // ---------- 8. Version ----------
  check('index : bump v217', fs.readFileSync('public/index.html', 'utf8').includes('?v=277'));
  check('sw : bump botdev-v241', fs.readFileSync('public/sw.js', 'utf8').includes('botdev-v277'));
