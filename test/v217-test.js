...
(async () => {
  ...
  // ---------- 8. Version ----------
  check('index : bump v217', fs.readFileSync('public/index.html', 'utf8').includes('?v=264'));
  check('sw : bump botdev-v241', fs.readFileSync('public/sw.js', 'utf8').includes('botdev-v264'));
