...
check('index.html : 7 références ?v=238', (read('public/index.html').match(/\?v=238/g) || []).length === 7);
check('index.html : plus aucune référence ?v=230', !read('public/index.html').includes('?v=230'));
check('sw.js : cache botdev-v238', read('public/sw.js').includes("const CACHE = 'botdev-v238';"));
