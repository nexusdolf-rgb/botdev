...
//
// Les deux clauses tactiles (800-900 px, et « paysage peu haut ») exigent
...
check('plus aucune clause « 800-900 px tactile » sans any-pointer', nue2 === 0, String(nue2));
check('plus aucune clause « paysage peu haut » sans any-pointer', nue3 === 0, String(nue3));
check('le plancher « tout le monde en mobile » sous 800 px est inchangé',
...
check('le repli sans matchMedia garde le plancher 800 px',
...
check('…et la clause tactile 800-900 px aussi',
