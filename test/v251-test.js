...
check('index.html : ?v=298 référencé 7 fois', (index.match(/\?v=298/g) || []).length === 7,
  String((index.match(/\?v=298/g) || []).length));
check('sw.js : cache « botdev-v298 »', sw.includes("const CACHE = 'botdev-v298';"));
