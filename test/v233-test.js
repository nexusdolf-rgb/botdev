...
check('index.html : 7 références ?v=326', (read('public/index.html').match(/\?v=326/g) || []).length === 7);
check('index.html : plus aucune référence ?v=232', !read('public/index.html').includes('?v=232'));
check('sw.js : cache botdev-v241', read('public/sw.js').includes("const CACHE = 'botdev-v326';"));
