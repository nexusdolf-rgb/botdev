...
function dbStats(db) {
  ...
  const tables = ['users', 'sessions', 'bots', 'commands', 'role_menus', 'tickets', 'advanced_ticket_panels', 'advanced_ticket_channels', 'xp', 'economy', 'warnings', 'automod_member_blacklist', 'automod_blacklist_counters', 'automod_warning_messages', 'suggestions', 'giveaways', 'transcripts', 'message_stats', 'join_stats', 'shop_purchases', 'reminders', 'marriages', 'birthdays', 'temp_roles', 'scheduled_messages', 'cmd_stats', 'open_tickets', 'ticket_ratings'];
  try {
