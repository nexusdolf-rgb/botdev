...
const STRINGS = {
  fr: {
    ...
    ticket_close_opener: '🔒 Ticket fermé par le créateur du ticket.',
    ticket_close_opener_reply: '🔒 Ticket fermé. Le staff peut le réouvrir — et la transcription sera envoyée à la suppression.',
  ...
  en: {
    ...
    ticket_close_opener: '🔒 Ticket closed by its creator.',
    ticket_close_opener_reply: '🔒 Ticket closed. The staff can reopen it — the transcript will be sent on deletion.',
