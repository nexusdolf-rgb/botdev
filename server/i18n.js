...
const STRINGS = {
  fr: {
    ...
    verif_panel_title: '✅ Vérification',
    verif_panel_desc: 'Bienvenue ! Cliquez sur le bouton ci-dessous pour prouver que vous êtes humain et accéder au serveur.\nRôle accordé : {role}',
    verif_button: 'Je suis humain',
    verif_ok: '✅ Vous êtes vérifié ! Bon séjour sur le serveur.',
    verif_already: '✅ Vous êtes déjà vérifié.',
    verif_off: '⚠️ La vérification n est pas activée sur ce serveur.',
    verif_no_role: '⚠️ Configuration incomplète : le rôle « vérifié » est introuvable. Prévenez un administrateur.',
    ...
    verif_need_avatar: '🖼️ Ajoutez une photo de profil à votre compte Discord, puis cliquez à nouveau.',
    verif_spammer: '🚫 Discord a signalé ce compte comme indésirable. La vérification est refusée.',
    links_panel_title: '🔗 Liens utiles',
    links_panel_desc: 'Retrouvez les liens officiels du serveur ci-dessous.',
    invite_reward_msg: '🎉 **{inviter}** vient d\'atteindre **{count} invitations valides** ! Rôle {role} débloqué.',
    gw_participants_btn: '👥 Participants',
    gw_participants_title: '👥 Participants — {prize}',
    gw_participants_count: '{count} participant(s) :',
    gw_participants_none: 'Aucun participant pour le moment — réagissez avec 🎉 pour participer !',
    gw_participants_gone: 'Ce giveaway est introuvable ou déjà terminé.',
    gw_cond_role: 'Rôle {role} requis',
    gw_cond_level: 'Niveau {level} minimum',
    gw_denied_dm: '❌ Giveaway « {prize} » : {reason} Votre réaction a été retirée.',
    gw_denied_role: 'le rôle {role} est requis pour participer.',
    gw_denied_level: 'le niveau {level} minimum est requis pour participer.',
    gw_reminder: '⏰ Plus que quelques minutes ! Le giveaway **{prize}** se termine {time} — réagissez avec 🎉 pour participer.',
  ...
  en: {
    ...
    verif_panel_title: '✅ Verification',
    verif_panel_desc: 'Welcome! Click the button below to prove you are human and access the server.\nRole granted: {role}',
    verif_button: 'I am human',
    verif_ok: '✅ You are verified! Enjoy the server.',
    verif_already: '✅ You are already verified.',
    verif_off: '⚠️ Verification is not enabled on this server.',
    verif_no_role: '⚠️ Incomplete setup: the verified role cannot be found. Please tell an administrator.',
    ...
    verif_need_avatar: '🖼️ Please set a Discord profile picture, then click again.',
    verif_spammer: '🚫 Discord has flagged this account as a spammer. Verification is denied.',
    links_panel_title: '🔗 Useful links',
    links_panel_desc: 'Find the server’s official links below.',
    invite_reward_msg: '🎉 **{inviter}** just reached **{count} valid invites**! Role {role} unlocked.',
    gw_participants_btn: '👥 Participants',
    gw_participants_title: '👥 Participants — {prize}',
    gw_participants_count: '{count} participant(s):',
    gw_participants_none: 'No participants yet — react with 🎉 to enter!',
    gw_participants_gone: 'This giveaway cannot be found or already ended.',
    gw_cond_role: 'Role {role} required',
    gw_cond_level: 'Level {level} minimum',
    gw_denied_dm: '❌ Giveaway "{prize}": {reason} Your reaction was removed.',
    gw_denied_role: 'the role {role} is required to enter.',
    gw_denied_level: 'level {level} minimum is required to enter.',
    gw_reminder: '⏰ Only a few minutes left! The **{prize}** giveaway ends {time} — react with 🎉 to enter.',
