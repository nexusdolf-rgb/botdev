...
const STRINGS = {
  fr: {
    ...
    ticket_add_accepted: '✅ Ce que tu peux saisir',
    ticket_add_accepted_value: '• une **@mention** — tape `@` puis le début du pseudo\n• l\'**identifiant** Discord — 17 à 20 chiffres\n• le **pseudo** ou le **surnom** exact dans ce serveur\n• un **début de pseudo** — je te propose la liste si plusieurs membres correspondent',
    ...
    ticket_add_amb_desc: '« {query} » correspond à **{count}** membres de **{server}**. Choisis le bon ci-dessous :',
